...
// Data
const data = require('~data/flowControl/TC040_TextAreaDoesNotContain.json');
// Verify
...
Scenario('User is redirected to Step3 if text area does not contain the input', async () => {
  ...
  flowControlActions.insertNewRecordSkipStep2TextArea(data.textPortal, data.textPortal2, data.fieldPortal);
  await commonActions.logoutFromApp();
});
