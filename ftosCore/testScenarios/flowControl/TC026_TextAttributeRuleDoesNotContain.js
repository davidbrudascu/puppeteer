...
// Data
const data = require('~data/flowControl/TC026_TextAttributeRuleDoesNotContain.json');
// Verify
...
Scenario('User is redirected to Step3 if Text Input does not contain the given record', async () => {
