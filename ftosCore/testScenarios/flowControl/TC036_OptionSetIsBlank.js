...
// Data
const data = require('~data/flowControl/TC036_OptionSetIsBlank');
// Verify
...
Scenario('User is redirected to Step3 if option set attribute is blank', async () => {
  ...
  flowControlActions.insertFormOptionSetIsBlank(
    data.nameFormPortal,
    data.thirdStep,
    data.secondRecord,
    data.secondStep,
