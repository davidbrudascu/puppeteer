...
// Data
const data = require('~data/flowControl/TC042_TextAreaIsNotBlank.json');
// Verify
...
Scenario('User is redirected to Step3 if text area is not blank', async () => {
  ...
  flowControlActions.insertNewRecordSkipStep2TextAreaReverse(data.textPortal, data.textPortal2, data.fieldPortal);
  await commonActions.logoutFromApp();
});
