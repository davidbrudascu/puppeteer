...
// Data
const data = require('~data/flowControl/TC045_FlowControlNumericIsGraterOrEqual.json');
...
Scenario('User is redirected to Step3 if the numeric input is grater or equal', async () => {
