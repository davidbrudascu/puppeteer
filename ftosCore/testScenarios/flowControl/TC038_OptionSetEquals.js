...
// Data
const data = require('~data/flowControl/TC038_OptionSetEquals.json');
// Verify
...
Scenario('User is redirected to Step3 if option set attribute equals with the given record', async () => {
  ...
  flowControlActions.insertFormOptionSetEquals(
    data.firstRecord,
    data.nameFormPortal,
    data.thirdStep,
    data.secondRecord,
