...
// Data
const data = require('~data/flowControl/TC044_FlowControlNumericIsNotBlank.json');
...
Scenario('User is redirected to Step3 if the numeric input is not blank', async () => {
  ...
  flowControlActions.insertNewRecordSkipStep2Reverse(data.textPortal, data.textPortal2, data.fieldPortal);
  await commonActions.logoutFromApp();
});
