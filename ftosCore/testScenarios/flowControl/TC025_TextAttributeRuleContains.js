...
// Data
const data = require('~data/flowControl/TC025_TextAttributeRuleContains.json');
// Verify
...
Scenario('User is redirected to Step3 if Text Input contains the given record', async () => {
