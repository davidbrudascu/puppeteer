...
// Data
const data = require('~data/flowControl/TC034_BoolNullTrue');
// Verify
...
Scenario('User is redirected to Step3 if bool attribute is true', async () => {
  ...
  flowControlActions.insertFormBoolIsTrue(
    data.nameFormPortal,
    data.secondStep,
    data.thirdStep,
  );
