...
// Data
const data = require('~data/coding/basicForm');
// Pages
...
Scenario('Coding - Basic Form Before/After Js', async () => {
  // Toast message order
  const toastOrder = [
    {
  ...
  // 17 Check if "Form After Events" error message is displayed
  await codeVerify.verifyToastMessageOrder(toastOrder);
  commonActions.closeToastMessage(
    commonPage.messagePopup.errorMessage,
    data.toastMessage1,
