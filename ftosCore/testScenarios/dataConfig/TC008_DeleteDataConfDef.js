...
// Data
const data = require('~data/dataConfig/TC008_DeleteDataConfDef');
// Verify
...
Scenario('User can create and delete a Data Definition', async () => {
  ...
  commonVerify.verifyToastMessage(commonPage.messagePopup.successMessage, constants.TOAST_VANISH);
  await dataConfigActions.deleteDataDefinition(data.nameDataDefinition, data.columnName);
