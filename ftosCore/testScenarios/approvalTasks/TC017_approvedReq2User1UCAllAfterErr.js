...
Scenario('Approve a request with IsAdvisory=True, Competence Approval Mode=All with 2 Users/1 User Competence which has an After Script Error.', async () => {
  ...
  approvalTaskActions.insertRecord(specificData.recordNameTC017);
  ...
  approvalTaskActions.openApprovalTask(specificData.approvalUsername1, specificData.recordNameTC017);
  ...
  approvalTaskActions.openApprovalTask(specificData.approvalUsername2, specificData.recordNameTC017);
