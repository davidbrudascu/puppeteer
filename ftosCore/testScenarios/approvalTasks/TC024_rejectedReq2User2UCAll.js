...
Scenario('Reject a request with IsAdvisory=True, Competence Approval Mode=All with 2 Users/2 User Competence.', async () => {
  ...
  approvalTaskActions.insertRecord(specificData.recordNameTC024);
  ...
  approvalTaskActions.openApprovalTask(specificData.approvalUsername1, specificData.recordNameTC024);
