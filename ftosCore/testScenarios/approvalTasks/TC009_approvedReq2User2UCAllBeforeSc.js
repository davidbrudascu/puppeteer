...
Scenario('Approve a request with IsAdvisory=True, Competence Approval Mode=All with 2 Users/2 User Competence which has a Before Script.', async () => {
  ...
  approvalTaskActions.insertRecord(specificData.recordNameTC009);
  ...
  approvalTaskActions.openApprovalTask(specificData.approvalUsername1, specificData.recordNameTC009);
