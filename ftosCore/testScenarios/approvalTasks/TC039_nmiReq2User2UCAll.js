...
Scenario('Return (Need More Info) a request with IsAdvisory=True, Competence Approval Mode=All with 2 Users/2 User Competence.', async () => {
  ...
  approvalTaskActions.insertRecord(specificData.recordNameTC039);
  ...
  approvalTaskActions.openApprovalTask(specificData.approvalUsername1, specificData.recordNameTC039);
