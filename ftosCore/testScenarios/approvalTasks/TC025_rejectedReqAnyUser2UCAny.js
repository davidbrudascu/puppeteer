...
Scenario('Reject a request with IsAdvisory=False, Competence Approval Mode=Any with 2 Users/2 User Competence.', async () => {
  ...
  approvalTaskActions.insertRecord(specificData.recordNameTC025);
  ...
  // Open Approval Task
  approvalTaskActions.openApprovalTask(specificData.subjectType, specificData.recordNameTC025);
