...
Scenario('Approve a request with IsAdvisory=False, Competence Approval Mode=Any with 2 Users/2 User Competence which has an After Script Error.', async () => {
  ...
  approvalTaskActions.insertRecord(specificData.recordNameTC020);
  ...
  // Open Approval Task
  approvalTaskActions.openApprovalTask(specificData.subjectType, specificData.recordNameTC020);
