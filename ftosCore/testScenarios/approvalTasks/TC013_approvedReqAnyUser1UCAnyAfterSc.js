...
Scenario('Approve a request with IsAdvisory=True, Competence Approval Mode=Any with 2 Users/1 User Competence which has an After Script.', async () => {
  ...
  approvalTaskActions.insertRecord(specificData.recordNameTC013);
  ...
  approvalTaskActions.openApprovalTask(specificData.subjectType, specificData.recordNameTC013);
