...
Scenario('Approve a request with IsAdvisory=True, Competence Approval Mode=Any with 2 Users/1 User Competence which has an After Script Error.', async () => {
  ...
  approvalTaskActions.insertRecord(specificData.recordNameTC018);
  ...
  approvalTaskActions.openApprovalTask(specificData.subjectType, specificData.recordNameTC018);
