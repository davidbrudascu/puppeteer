...
Scenario('Reject a request with IsAdvisory=True, Competence Approval Mode=All with 2 Users/1 User Competence.', async () => {
  ...
  approvalTaskActions.insertRecord(specificData.recordNameTC022);
  ...
  approvalTaskVerify.verifyMultipleApprovalTaskCreation1UC(
    specificData.recordNameTC022,
    specificData.approvalUsername1,
    specificData.approvalUsername2,
    commonData.competenceLevel1,
    commonData.taskStatusActive,
  );
  // Open Approval Task for User 1commonData.recordName
  approvalTaskActions.openApprovalTask(specificData.approvalUsername1, specificData.recordNameTC022);
  ...
  approvalTaskActions.openApprovalTask(specificData.approvalUsername2, specificData.recordNameTC022);
