...
Scenario('Approve a request with IsAdvisory=False, Competence Approval Mode=Any with 2 Users/2 User Competence which has a Before Script.', async () => {
  ...
  approvalTaskActions.insertRecord(specificData.recordNameTC010);
  ...
  // Open Approval Task
  approvalTaskActions.openApprovalTask(specificData.subjectType, specificData.recordNameTC010);
