...
Scenario('Approve a request with IsAdvisory=True, Competence Approval Mode=Any with 2 Users/1 User Competence which has a Before Script.', async () => {
  ...
  approvalTaskActions.insertRecord(specificData.recordNameTC008);
  ...
  approvalTaskActions.openApprovalTask(specificData.subjectType, specificData.recordNameTC008);
