...
Scenario('Reject a request with IsAdvisory=True, Competence Approval Mode=All with 2 Users/1 User Competence which has a Before Script.', async () => {
  ...
  approvalTaskActions.insertRecord(specificData.recordNameTC027);
  ...
  approvalTaskActions.openApprovalTask(specificData.approvalUsername1, specificData.recordNameTC027);
  ...
  approvalTaskActions.openApprovalTask(specificData.approvalUsername2, specificData.recordNameTC027);
