...
Scenario('Approve a request with IsAdvisory=True, Competence Approval Mode=Any with 2 Users/1 User Competence.', async () => {
  ...
  approvalTaskActions.insertRecord(specificData.recordNameTC003);
  ...
  approvalTaskActions.openApprovalTask(specificData.subjectType, specificData.recordNameTC003);
