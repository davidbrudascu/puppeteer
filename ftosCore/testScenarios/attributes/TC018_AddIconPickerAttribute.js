...
// Data
const data = require('~data/attributes/TC018_AddIconPickerAttribute');
// Verify
...
Scenario('User can add an Icon Picker attribute to an entity.', async () => {
