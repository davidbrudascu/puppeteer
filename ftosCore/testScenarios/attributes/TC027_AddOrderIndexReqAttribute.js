...
// Data
const data = require('~data/attributes/TC027_AddOrderIndexReqAttribute');
// Verify
...
Scenario('User can add an Order Index Required attribute to an entity.', async () => {
  ...
  attributeActions.addAttributeAction(
      data.orderIndexReqAttributeName,
